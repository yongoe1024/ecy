  ...
  <div>
    ...
    <div class="head"
      ...
      <el-input size="small"
                prefix-icon="el-icon-search"
                placeholder="请输入字典类型"
                v-model="queryParam.type"></el-input>
    </div>
    <!-- 按钮 -->
    <div class="button">
    ...
    <el-table v-loading="loading"
      ...
      <el-table-column prop="name"
        ...
        <template slot-scope="scope">
          <router-link :to="{
                path: 'dict-date',  query :{ dictId:scope.row.id}
                }">{{scope.row.name}}
          </router-link>
        </template>
      </el-table-column>
      <el-table-column prop="type"
                       ...
                       align="center">
        <template slot-scope="scope">
          <span v-if="scope.row.type===1">下拉框</span>
          <span v-else-if="scope.row.type===2">单选</span>
        </template>
      </el-table-column>
      ...
      <el-form ref="form"
        ...
        <el-form-item label="字典类型"
          ...
          <el-select v-model="form.type">
            <el-option v-for="item in [{name:'下拉框',type:1},{name:'单选',type:2}]"
                       :key="item.type"
                       :label="item.name"
                       :value="item.type">
            </el-option>
